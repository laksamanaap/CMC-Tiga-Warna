...
if ($password1 == $password2)
{
    ...
    include "environment/koneksi.php";
...
else echo "Password yang anda masukan tidak sama!";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    .container {
        ...
        border-radius:30px;
        transition:1s;
        box-shadow: 2px 2px 10px rgba(0.5, 0.5, 0.5, 0.6);
    ...
    .container:hover {
        transition:1s;
            transform: scale(1.1);
            box-shadow: 10px 10px 30px rgba(0.5, 0.5, 0.5, 0.6);
    }
    ...
    <div class="container">
        <div class="ceklist">
            ...
            C131.967,94.755,132.296,93.271,131.583,92.152z" />
                <circle fill="none" stroke="#736357" stroke-width="4" stroke-miterlimit="10" cx="109.486" cy="104.353" r="32.53" />
            </svg>
        </div>
    <h3>User berhasil terdaftar!</h3>
        <p align="center"><a href="login.php">Masuk</a></p>
    </div>
</body>
</html>