        ...
        <div class="box-1" style="background-color:#e5e5e5;">
            <div class="box-inner-1 pb-3 mb-3 ">
                <div class="d-flex justify-content-between mb-3 userdetails">
                    <p class="fw-bold">Paket Explore Hutan</p>
                ...
                <div id="my" class="carousel slide carousel-fade img-details" data-bs-ride="carousel"
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/img/explore_hutan/explore-hutan.jpg"
                                class="d-block w-100">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/img/explore_hutan/explore-hutan-2.jpg"
                                class="d-block w-100">
                        </div>
                        <div class="carousel-item">
                        <img src="assets/img/explore_hutan/explore-hutan-3.jpg"
                                class="d-block w-100">
                        </div>
                    </div>
