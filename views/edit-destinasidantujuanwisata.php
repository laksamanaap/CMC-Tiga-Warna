...
$data = mysqli_query($conn, "SELECT * FROM tb_destinasidantujuanwisata WHERE id_destinasidantujuanwisata = '".$_GET['id']."'");
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                    <input type="text" name="subjudul" value="<?php echo $subjudul ?>">
                    </td>
                </tr>
                <tr>
                    <td>Fasilitas</td>
...
if(isset($_POST['kirim'])) {
    ...
    $update = mysqli_query($conn, "UPDATE tb_destinasidantujuanwisata SET 
    judul = '".$judul."',
    subjudul = '".$subjudul."',
    fasilitas = '".$fasilitas."',
    isi = '".$isi."'
    WHERE id_destinasidantujuanwisata = '".$_GET['id']."'
    ");
    if($update) {
