        ...
        <div class="box-1" style="background-color:#e5e5e5;">
            <div class="box-inner-1 pb-3 mb-3 ">
                <div class="d-flex justify-content-between mb-3 userdetails">
                    <p class="fw-bold">Paket Banana Boat</p>
                ...
                data-bs-interval="2000">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/img/banana_boat/banana-boat.jpg"
                                class="d-block w-100">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/img/banana_boat/banana-boat-2.jpg"
                                class="d-block w-100">
                              </div>
                              <div class="carousel-item">
                        <img src="assets/img/banana_boat/banana-boat-3.jpg"
                        class="d-block w-100">
                        </div>
                    </div>
