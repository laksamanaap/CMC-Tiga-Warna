...
<div class="d-flex" id="wrapper">
    ...
    <h1 align="center">Data tempat penginapan</h1>
    <a href="tambah-data-tempatpenginapan.php">Tambah</a>
    <table border="1">
        <tr>
            <td>No</td>
            <td>Judul</td>
        ...
        $query = mysqli_query($conn, "SELECT * FROM tb_tempatpenginapan");
        while ($row = mysqli_fetch_array($query)) {
        ?>
        <tr>
        <td><?php echo $row['id_tempatpenginapan']?></td>
            <td><?php echo $row['judul']?></td>
            <td><?php echo $row['fasilitas']?></td>
            <td><?php echo $row['isi']?></td>
            <td>
            <a href="read-tempatpenginapan.php?id=<?php echo $row['id_tempatpenginapan'] ?>">View</a> |
                <a href="edit-tempatpenginapan.php?id=<?php echo $row['id_tempatpenginapan'] ?>">Update</a> |
                <a href="hapus-tempatpenginapan.php?id=<?php echo $row['id_tempatpenginapan'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')">Delete</a>
            </td>
        </tr>
