...
if (isset($_SESSION['level']) && isset($_SESSION['username'])) {
    if ($_SESSION['level'] == "admin") {
       echo "<h3 align='center'>Hi <b><u>". $_SESSION['username'] ."</b></u><b>!</b>&nbsp;(admin)</h1>";
    }
  ...
  <nav class="navbar navbar-expand-xl py-4 ">
          <div class="container-fluid">
            ...
            <div class="collapse px-5 navbar-collapse justify-content-between" id="navbarTogglerDemo01">
              ...
              <div class="loginopt">
            <a href="loginform.php" class="register text-decoration-none text-light mr-3">Login</a>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-lg-6">
                    <h2 class="text-head mb-2">
                      <font color="#00AAA0">CMC</font>&nbsp;<font color="#008D85">Tiga</font>&nbsp;<font color="#00736C">Warna</font>
                    </h2>
                    <div class="break-small mb-4"></div>
                    <div class="text-container">
                      <p class="text-para">
                      CMC Tiga Warna terletak di Desa Tambakrejo, Kec. Sumbermanjing Wetan, Kabupaten Malang. 
                      Ekowisata ini dikelola oleh masyarakat lokal Sendang Biru yang tergabung dalam Yayasan Bhakti Alam Sendang Biru. 
                      Total masyarakat yang terlibat dalam pengelolaan ekowisata ini adalah 107 orang.
                      </p>
                      <p class="text-para-2">
                      Kawasan CMC Tiga Warna ini dibagi menjadi 2 area konservasi yaitu 
                      area konservasi mangrove (Clungup & Gatra) dan area konservasi
                      terumbu karang (Pantai Sapana, Pantai mini, Pantai Batu Pecah dan
                      Tiga Warna). Total luasan area mencapai 117 Ha Terdiri dari 71 Ha
                      mangrove, 10 Ha terumbu karang dan 36 Ha hutan lindung.
                      </p>
                      <p class="text-para-3">
                      ...
                      Conservation. Dengan karakteristik tersebut wisatawan yang berkunjung
                      ke CMC Tiga Warna akan merasa aman dan menyatu dengan kelestarian
                      alam, jauh dari kebisingan, dan mengoptimalkan private time for gathering.
                      </p>
                    </div>
                  </div>
                </div>
