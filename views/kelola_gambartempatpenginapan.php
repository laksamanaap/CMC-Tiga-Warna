...
<div class="d-flex" id="wrapper">
    ...
    <h2>Data Gambar</h2>
    <a href="tambah-data-gambartempatpenginapan.php">Tambah</a>
    <table border="1">
        <tr>
            <td>Judul</td>
            <td>Nama</td>
        ...
        $query = mysqli_query($conn, "SELECT * FROM tb_gambartempatpenginapan");
        while ($row = mysqli_fetch_array($query)) {
        ?>
        <tr>
            <td><?php echo $row['id_gambar']?></td>
            <td><?php echo $row['nama']?></td>
            <td><img src="../img_penginapan/<?php echo $row['file']?>" width="300px" height="200px"></td>
            <td>
                <a href="edit-gambartempatpenginapan.php?id=<?php echo $row['id_gambar'] ?>">Update</a> |
                <a href="hapus-gambartempatpenginapan.php?id=<?php echo $row['id_gambar'] ?> " onclick="return confirm('Apakah anda yakin akan menghapus data?')">Delete</a>
            </td>
        </tr>
