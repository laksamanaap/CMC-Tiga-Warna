...
$data = mysqli_query($conn, "SELECT * FROM tb_gambardestinasidantujuanwisata WHERE id_gambar = '".$_GET['id']."'");
...
if(isset($_POST['kirim'])) {
    ...
    if($nama_file != '') {
        ...
        $update = mysqli_query($conn, "UPDATE tb_gambardestinasidantujuanwisata SET 
        nama = '".$nama."',
        file = '".$nama_file."'
