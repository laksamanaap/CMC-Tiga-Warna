...
<div class="d-flex" id="wrapper">
    ...
    <table border="1">
        ...
        $query = mysqli_query($conn, "SELECT * FROM tb_transaksidestinasidantujuanwisata");
        while ($row = mysqli_fetch_array($query)) {
        ?>
        <tr>
        <td><?php echo $row['id_transaksidestinasidantujuanwisata']?></td>
            ...
            <td><?php echo $row['jam_pemesanan']?></td>
            <td><?php echo $row['catatan']?></td>
            <td><?php echo $row['paket']?></td>
            <td>
                <a href="read-transaksidestinasidantujuanwisata.php?id=<?php echo $row['id_transaksidestinasidantujuanwisata'] ?>">View</a> |
                <a href="hapus-transaksidestinasidantujuanwisata.php?id=<?php echo $row['id_transaksidestinasidantujuanwisata'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')">Delete</a>
            </td>
        </tr>
    ...
    <table border="1">
        ...
        $query = mysqli_query($conn, "SELECT * FROM tb_buktitransaksidestinasidantujuanwisata");
        while ($row = mysqli_fetch_array($query)) {
        ?>
        <tr>
            <td align="center"><b><?php echo $row['id_gambar']?></b></td>
            <td><img src="../img_buktitransaksidestinasidantujuanwisata/<?php echo $row['file']?>" width="500px" height="800px"></td>
            <td>
                <a href="read-buktitransaksidestinasidantujuanwisata.php?id=<?php echo $row['id_gambar'] ?>">View</a> |
                <a href="hapus-buktitransaksidestinasidantujuanwisata.php?id=<?php echo $row['id_gambar'] ?> " onclick="return confirm('Apakah anda yakin akan menghapus data?')">Delete</a>
            </td>
        </tr>
